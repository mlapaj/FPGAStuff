...
from amaranth import Signal, Module, Elaboratable, ClockDomain, ClockSignal, ResetSignal, Cat
...
class Blinky(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m = Module()
        m.submodules.clock_gen = platform.clock_domain_generator()
        ...
        counter = Signal(28)
        m.d.normal += counter.eq(counter + 1)
